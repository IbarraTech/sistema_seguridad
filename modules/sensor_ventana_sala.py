    ...
    try:
        while True:
            if GPIO.input(pulsador_encendido_pin) == GPIO.HIGH and not led_encendido:
                ...
                led_encendido = True
                time.sleep(1.0)
                envio_correos.envio_correos("ventana sala")
